...
# ------------ GA CONFIG -----------------
POPULATION_SIZE = 100 # Number of candidates in a population
NUM_GENERATIONS = 200 # Number of generations the GA runs for
...
SHIFT_RANGE_HOURS = 6 # Number of hours an event can be shifted by
...
UNSCHEDULED_EVENTS_PENALTY = 10000000 # Total fitness penalty per event left unscheduled
